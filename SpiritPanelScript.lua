...
-- With integrated Season Change functionality --
...
function doSetup(params)
    ...
    playerColor = color
    -- The panel is now self, since script is embedded in panel
    local panel = params.spiritPanel or self
